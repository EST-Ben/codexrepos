...
def merge_family(entry, fam):
    ...
    for k in ["motion_system","enclosed","build_volume_mm","workarea_mm","nozzle_diameters",
              "max_nozzle_temp_c","max_bed_temp_c","spindle_rpm_range","max_feed_mm_min",
              "rigidity_class","capabilities","aliases","notes"]:
        data[k] = entry.get(k, data.get(k))
    return data
