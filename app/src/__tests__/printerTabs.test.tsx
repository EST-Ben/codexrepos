...
// Use a "mock*" prefix so Jest allows referencing inside jest.mock factories
...
describe('PrinterTabs', () => {
  ...
  it('submits uploads with machine meta and experience', async () => {
    ...
    // 1) Pick image via the mock picker
    fireEvent.press(screen.getByText('Pick / Capture photo'));
    // 2) Trigger actual analyze button from PrinterTabs UI
