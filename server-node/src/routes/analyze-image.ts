...
import { z } from "zod";
import { analyzeImage as runPipeline } from "../pipeline";
...
const MetaSchema = z.object({
  ...
  base_profile: z.record(z.number()).optional(),
...
export const analyzeImageRoute: FastifyPluginCallback = (
  ...
  app.post("/analyze-image", async (req: FastifyRequest, reply: FastifyReply) => {
